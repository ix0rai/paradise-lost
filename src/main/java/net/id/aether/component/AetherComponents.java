...
public class AetherComponents implements EntityComponentInitializer {
    ...
    public static final ComponentKey<LoreState> LORE_STATE_KEY = ComponentRegistry.getOrCreate(Aether.locate("lore_state"), LoreState.class);
    public static final ComponentKey<LUV> LUV_KEY = ComponentRegistry.getOrCreate(Aether.locate("luv"), LUV.class);
    ...
    public void registerEntityComponentFactories(EntityComponentFactoryRegistry registry) {
        ...
        registry.registerForPlayers(LORE_STATE_KEY, LoreState.Impl::new, RespawnCopyStrategy.ALWAYS_COPY);
        registry.registerForPlayers(LUV_KEY, LUV::new);
    }
}
